 ...
 * @author Joao
 */
public class Banco extends InternalFrame {
    ...
    public Banco(Connection conn, BancoControler controller) {
        this.conn = conn;
    ...
    public Banco(Connection conn, GridController dataController) {
        try {
            this.conn = conn;
            initComponents();
    ...
    private void initComponents() {
        ...
        gridControl1.setValueObjectClassName("br.com.jumbo.vo.BancoVO");
        ...
        textColumn1.setHeaderColumnName("Nome Banco");
