 ...
 * @version 1.0
 */
public class CoresControler extends GridController implements GridDataLocator {

    
    private Cores grid = null;
    private Connection conn = null;
    private Cores coresFrame = null;
     private String pk = null;   //  private Date data = new Date();
...
*/
    public CoresControler(Connection conn) {
